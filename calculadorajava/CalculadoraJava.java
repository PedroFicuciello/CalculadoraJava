...
public class CalculadoraJava extends JFrame {
	...
	public CalculadoraJava(){
		...
		paine.add(btnMC);
		btnMC.addActionListener((ActionEvent e) -> {
                    memoria = 0;
                    sinal = " ";
                    visor.setText("");
                });
		...
		paine.add(btnMR);
		btnMR.addActionListener((ActionEvent e) -> {
                    sinal = " ";
		...
		paine.add(btnMS);
		btnMS.addActionListener((ActionEvent e) -> {
		...
		paine.add(backsp);
		backsp.addActionListener((ActionEvent bakcspace) -> {
		...
		paine.add(btnCE);
		btnCE.addActionListener((ActionEvent e) -> {
                    visor.setText("0");
                });
		...
		paine.add(btnmom);
		btnmom.addActionListener((ActionEvent e) -> {
                    sinal = " ";
		...
		paine.add(btnraiz);
		btnraiz.addActionListener((ActionEvent e) -> {
		...
		paine.add(btnbarra);
		btnbarra.addActionListener((ActionEvent e) -> {
		...
		paine.add(btnporc);
		btnporc.addActionListener((ActionEvent e) -> {
                    valor1 = Double.parseDouble(visor.getText());
                    sinal = "percentual";
                    visor.setText("0");
                });
		...
		paine.add(btnfra);
		btnfra.addActionListener((ActionEvent fra) -> {
                    valor1 = Double.parseDouble(visor.getText());
                    sinal = "fra";
                    if(sinal.equals("fra")) {
		...
		paine.add(btnfmenos);
		btnfmenos.addActionListener((ActionEvent e) -> {
                    valor1 = Double.parseDouble(visor.getText());
                    sinal = "menos";
                    visor.setText("0");
                });
		...
		paine.add(btnfigual);
		btnfigual.addActionListener((ActionEvent e) -> {
		...
		paine.add(btnfmais);	
		btnfmais.addActionListener((ActionEvent e) -> {
                    valor1 = Double.parseDouble(visor.getText());
                    sinal = "soma";
                    visor.setText("0");
                });
